        ...
        <form method="post" action="{{route('newTicket.saveT')}}">
            ...
            <div class="row g-3 align-items-center">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="Comentarios" placeholder="Deja un Comentario..." value="{{old("Comentarios")}}">
                        <p class="fv-bold text-danger">{{$errors->first('Comentarios')}}</p>
                    </div>
                    <input type="hidden" name="IDSta" value="3">
                    <input type="hidden" name="IDCli" value="{{auth()->user()->IDU}}">
                    <input type="hidden" name="IDAux" value="">                        
