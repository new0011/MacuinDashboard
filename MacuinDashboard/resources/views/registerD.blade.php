...
<div class='container-fluid'>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Registro de Departamento</li>          
        </ol>
    </nav>
</div>
        ...
        <form method="post" action="{{route('registerD.saveD')}}">
            ...
            <div class="row g-3 align-items-center">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="NameDep" placeholder="Introduce el nombre del departamento..." value={{old('NameDep')}}>
                        <p class="fv-bold text-danger">{{$errors->first('NameDep')}}</p>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Descripción: </label>
                        <textarea required class="form-control" name="Descripcion" rows="3" placeholder="Desatate">{{old('Descripcion')}}</textarea>
