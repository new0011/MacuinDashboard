...
<div class='container-fluid'>
    ...
    <div class="container formxd">
        <div class="text-center mt-2">
            <h2 class="fw-normal">Editar Perfil</h2>
        </div>
        ...
        <form method="post" action="{{route('registerU.registered')}}">
            ...
            <div class="row g-3 align-items-center">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="nameU" placeholder="Introduce solo tu primer nomber o username..." value="{{$users->nameU}}">
                        <p class="fv-bold text-danger">{{$errors->first('nameU')}}</p>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Apellido paterno: </label>
                        <input required type="text" class="form-control" name="LastNameP" placeholder="Apellido Paterno..." value="{{$users->LastNameP}}">
                        <p class="fv-bold text-danger">{{$errors->first('LastNameP')}}</p>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Apellido materno: </label>
                        <input required type="text" class="form-control" name="LastNameM" placeholder="Apellido Materno..." value="{{$users->LastNameM}}">
                        <p class="fv-bold text-danger">{{$errors->first('LastNameM')}}</p>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Correo Electronico: </label>
                        <input required type="email" class="form-control" name="email" placeholder="Introduce tu correo personal..." value="{{$users->email}}">
